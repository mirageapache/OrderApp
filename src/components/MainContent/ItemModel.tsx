  ...
  optionList = optionArray.item.map((item: string, index: number) => {
    ...
    return (
      <span
        ...
        key={index}
        onClick={() => setOption(item, optionArray.type, index)}
      >
        {item}
      </span>
    );
      ...
      <div className="model-panel">
        ...
        <div className="model-body">
          ...
          <div className="customization">
            <h2>客製化選項</h2>
            <div className="option-div">{optionList}</div>
          </div>
        </div>
        <div className="model-footer">
          <span className="amount-option">
            ...
            />
            <button className="btn add-cart" onClick={addCartItem}>
              加入購物車
            </button>
          </span>
        </div>
